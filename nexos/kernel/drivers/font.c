...
/* ══════════════════════════════════════════════════════════════════════════
 * Complete IBM CP437 8×16 VGA font — 256 glyphs × 16 scan-lines
 * Source: standard VGA BIOS ROM (public domain)
 * ══════════════════════════════════════════════════════════════════════════ */
...
/* 0x05 */ {0x00,0x00,0x18,0x3C,0x3C,0xFF,0xE7,0xE7,0x18,0x3C,0x00,0x00,0x00,0x00,0x00,0x00},
/* 0x06 */ {0x00,0x00,0x18,0x3C,0x7E,0xFF,0xFF,0x7E,0x18,0x3C,0x00,0x00,0x00,0x00,0x00,0x00},
/* 0x07 */ {0x00,0x00,0x00,0x00,0x18,0x3C,0x3C,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
/* 0x08 */ {0xFF,0xFF,0xFF,0xFF,0xE7,0xC3,0xC3,0xE7,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF},
/* 0x09 */ {0x00,0x00,0x00,0x3C,0x66,0x42,0x42,0x66,0x3C,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
...
/* 0x0F */ {0x00,0x00,0x18,0xDB,0x3C,0xE7,0xE7,0x3C,0xDB,0x18,0x00,0x00,0x00,0x00,0x00,0x00},
...
/* 0x16 */ {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFE,0xFE,0xFE,0x00,0x00,0x00,0x00,0x00},
...
/* 0x2F / */        {0x00,0x00,0x00,0x00,0x06,0x06,0x0C,0x18,0x30,0x60,0xC0,0xC0,0x00,0x00,0x00,0x00},
...
/* 0x34 4 */        {0x00,0x00,0x0E,0x1E,0x36,0x66,0xC6,0xFE,0x06,0x06,0x06,0x0F,0x00,0x00,0x00,0x00},
...
/* 0x5C \ */        {0x00,0x00,0x00,0xC0,0xC0,0x60,0x30,0x18,0x0C,0x06,0x06,0x00,0x00,0x00,0x00,0x00},
...
/* 0x79 y */        {0x00,0x00,0x00,0x00,0x00,0xCC,0xCC,0xCC,0xCC,0xCC,0x7C,0x0C,0x18,0xF0,0x00,0x00},
...
/* 0x80-0xFF: use a generic block glyph for extended chars */
/* 0x80 */ {0x00,0x00,0x7E,0x81,0xA5,0x81,0x81,0xBD,0x99,0x81,0x7E,0x00,0x00,0x00,0x00,0x00},
/* 0x81 */ {0x00,0x00,0x7E,0xFF,0xDB,0xFF,0xFF,0xC3,0xE7,0xFF,0x7E,0x00,0x00,0x00,0x00,0x00},
...
void font_puts(int x, int y, const char *s, uint32_t fg, uint32_t bg) {
    ...
    while (*s) {
        if (*s == '\n') { x = ox; y += 16; }
        else { font_putchar(x, y, *s, fg, bg); x += 8; }
        s++;
    }
}
...
void font_puts2x(int x, int y, const char *s, uint32_t fg, uint32_t bg) {
    ...
    while (*s) {
        if (*s == '\n') { x = ox; y += 32; }
        else { font_putchar2x(x, y, *s, fg, bg); x += 16; }
        s++;
    }
}
